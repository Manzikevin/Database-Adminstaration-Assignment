...
<head>
    ...
    <title>Dashboard - HOPE SIMS</title>
...
<body class="font-sans text-slate-800 min-h-full flex flex-col antialiased selection:bg-blue-900 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="flex items-baseline space-x-2">
                    ...
                    <span class="hidden md:inline-block text-xs text-blue-200 border-l border-blue-700/60 pl-2 font-normal">Student Information System</span>
                </div>
            </div>
    ...
    <main class="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 space-y-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between pb-6 border-b border-slate-200/80 gap-4">
            <div>
                <div class="flex items-center space-x-2">
                    <h1 class="text-2xl sm:text-3xl font-bold text-blue-950 tracking-tight">Main Dashboard</h1>
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800 border border-emerald-200">
                        
                    </span>
                </div>
                <p class="text-sm text-slate-500 mt-1">Quick summary of departments, active classes, student enrollments, and daily administrative tasks.</p>
            </div>
            ...
            <div class="flex items-center space-x-3">
                <a href="view_records.php" class="inline-flex items-center space-x-2 px-4 py-2.5 rounded-lg text-xs font-semibold text-blue-950 bg-white border border-slate-300 shadow-sm hover:bg-slate-50 transition duration-150">
                    ...
                    <span>View All School Records</span>
                </a>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6">
                ...
                <div class="bg-white p-6 rounded-xl border border-slate-200/90 shadow-sm flex items-center justify-between">
                    <div>
                        ...
                        <span class="text-[11px] text-slate-500 mt-1 block">Active departments</span>
                    </div>
                ...
                <div class="bg-white p-6 rounded-xl border border-slate-200/90 shadow-sm flex items-center justify-between">
                    <div>
                        <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Total Courses</span>
                        <p class="text-3xl font-bold text-blue-950 mt-1"><?= htmlspecialchars($courseCount); ?></p>
                        <span class="text-[11px] text-slate-500 mt-1 block">Available courses</span>
                    </div>
                    <div class="w-12 h-12 bg-blue-50 border border-blue-100 rounded-xl flex items-center justify-center text-blue-900 shrink-0">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white p-6 rounded-xl border border-slate-200/90 shadow-sm flex items-center justify-between">
                    <div>
                        ...
                        <span class="text-[11px] text-slate-500 mt-1 block">Classes set for this term</span>
                    </div>
                ...
                <div class="bg-white p-6 rounded-xl border border-slate-200/90 shadow-sm flex items-center justify-between">
                    <div>
                        <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Total Enrollments</span>
                        <p class="text-3xl font-bold text-blue-950 mt-1"><?= htmlspecialchars($enrollCount); ?></p>
                        <span class="text-[11px] text-slate-500 mt-1 block">Students registered in classes</span>
                    </div>
                    <div class="w-12 h-12 bg-blue-50 border border-blue-100 rounded-xl flex items-center justify-center text-blue-900 shrink-0">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white p-6 rounded-xl border border-slate-200/90 shadow-sm flex items-center justify-between">
                    <div>
                        <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Submitted Grades</span>
                        <p class="text-3xl font-bold text-purple-900 mt-1"><?= htmlspecialchars($gradeCount); ?></p>
                        <span class="text-[11px] text-slate-500 mt-1 block">Grades entered into system</span>
                    </div>
        ...
        <section aria-labelledby="tasks-heading" class="space-y-4">
            <div class="flex items-center justify-between">
                <div>
                    <h2 id="tasks-heading" class="text-lg font-bold text-slate-900">Main Administrative Actions</h2>
                    <p class="text-xs text-slate-500">Perform common tasks like adding courses, scheduling classes, enrolling students, and adding grades.</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200/90 p-6 flex flex-col justify-between hover:border-blue-900/30 transition duration-150">
                    <div>
                        ...
                        <h3 class="text-base font-semibold text-slate-900 mb-1">1. Add New Course</h3>
                        <p class="text-xs text-slate-500 leading-relaxed mb-6">Create a new course and assign it to a department (<code class="text-slate-700 bg-slate-100 px-1 py-0.5 rounded">add_course.php</code>).</p>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200/90 p-6 flex flex-col justify-between hover:border-emerald-600/30 transition duration-150">
                    <div>
                        ...
                        <h3 class="text-base font-semibold text-slate-900 mb-1">2. Schedule Class</h3>
                        <p class="text-xs text-slate-500 leading-relaxed mb-6">Assign a course to a teacher, classroom, and semester (<code class="text-slate-700 bg-slate-100 px-1 py-0.5 rounded">schedule_class.php</code>).</p>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200/90 p-6 flex flex-col justify-between hover:border-blue-900/30 transition duration-150">
                    <div>
                        ...
                        <h3 class="text-base font-semibold text-slate-900 mb-1">3. Enroll Student</h3>
                        <p class="text-xs text-slate-500 leading-relaxed mb-6">Register a new student and sign them up for a scheduled class (<code class="text-slate-700 bg-slate-100 px-1 py-0.5 rounded">enroll_student.php</code>).</p>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200/90 p-6 flex flex-col justify-between hover:border-purple-600/30 transition duration-150">
                    <div>
                        ...
                        <h3 class="text-base font-semibold text-slate-900 mb-1">4. Enter Grades</h3>
                        <p class="text-xs text-slate-500 leading-relaxed mb-6">Record numerical marks and letter grades for enrolled students (<code class="text-slate-700 bg-slate-100 px-1 py-0.5 rounded">manage_grades.php</code>).</p>
                    </div>
        ...
        <section aria-labelledby="utilities-heading" class="space-y-4">
            <div>
                <h2 id="utilities-heading" class="text-lg font-bold text-slate-900">Manage System Setup & View Data</h2>
                <p class="text-xs text-slate-500">Manage basic school setup lists and view complete records across the system.</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <a href="manage_instructors.php" class="bg-white p-4 rounded-xl border border-slate-200/90 shadow-sm hover:border-blue-900/40 hover:shadow-md transition duration-150 flex items-center justify-between group">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-xs font-semibold text-slate-700 group-hover:text-blue-950 transition">Teachers</span>
                    </div>
                    <span class="text-[11px] font-medium bg-slate-100 text-slate-600 px-2 rounded-md group-hover:bg-blue-100 group-hover:text-blue-900 transition">Manage &rarr;</span>
                </a>
                ...
                <a href="view_records.php" class="bg-blue-50/70 p-4 rounded-xl border border-blue-200/80 shadow-sm hover:bg-blue-100/80 transition duration-150 flex items-center justify-between group">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-xs font-semibold text-blue-950">All Records</span>
                    </div>
    ...
    <footer class="mt-auto py-6 border-t border-slate-200 bg-white text-slate-500">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between text-xs gap-2">
            ...
            <div>
                &copy; <?= date('Y'); ?> University of Lay Adventists of Kigali.
            </div>
        </div>
    </footer>
